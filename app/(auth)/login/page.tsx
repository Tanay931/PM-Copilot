  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleEmailLogin} className="flex flex-col gap-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-sm font-medium" style={{ color: "var(--space)" }}>
              Password
            </label>
            <Link
              href="/reset-password"
          ...
          <input
            ...
            placeholder="••••••••"
            className="w-full px-3.5 py-2.5 rounded-lg border text-sm outline-none transition-colors focus:ring-2"
            style={{ borderColor: "var(--pine-100)", color: "var(--space)", background: "#fff" }}
          />
        </div>
        ...
        <button
          ...
          style={{ background: loading ? "var(--pine-light)" : "var(--pine)" }}
        >
      ...
      <p className="text-center text-sm mt-6" style={{ color: "#6b7280" }}>
        ...
        <Link href="/signup" className="font-semibold" style={{ color: "var(--pine)" }}>
          Sign up
        </Link>
      </p>
    </div>
